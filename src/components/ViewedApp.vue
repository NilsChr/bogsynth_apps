<template>
  <v-card>
    <v-toolbar dark color="transparent" flat dense>
      <v-btn icon dark @click="viewedApp = null">
    ...
    <v-container fluid>
        <v-layout id="header">
            <v-flex x3>
                <v-card img="https://picsum.photos/90/90" height="90" width="90"></v-card>
                
            </v-flex>
            <v-flex xs7>
                <v-layout>
                    <v-flex xs12><label id="title">{{viewedApp.title}}</label></v-flex>
                </v-layout>
            </v-flex>
        </v-layout>
